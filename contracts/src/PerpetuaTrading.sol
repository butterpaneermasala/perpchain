    ...
    AutomationCompatibleInterface // Enables Chainlink automation for liquidations
{
    ...
    function openPosition(
        ...
        // Get user's available collateral value
        ...
        // Store position in mapping
        positions[nextPositionId] = newPosition;
        // Add position ID to user's list
        userPositions[msg.sender].push(nextPositionId);

        // Reserve collateral for this position
    ...
    function closePosition(uint256 positionId) external nonReentrant {
        ...
        // Calculate profit or loss (PnL)
        int256 pnl = _calculatePnL(position, currentPrice);
        pnl -= fundingPayment; // Subtract funding payment from PnL
        ...
        // Settle the position (update balances, etc.)
