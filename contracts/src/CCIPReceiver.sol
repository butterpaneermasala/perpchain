...
import {CCIPReceiver} from "@chainlink/contracts-ccip/src/v0.8/ccip/libraries/CCIPReceiver.sol";
    ...
    AccessControl
{
    ...
    constructor(
        ...
        require(
            _perpetualTrading != address(0),
            "Invalid perpetual trading address"
        );
