...
"[project]/node_modules/@walletconnect/core/node_modules/unstorage/dist/shared/unstorage.CoCt7NXC.mjs [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function createStorage(options = {}) {
    ...
    const onChange = (event, key)=>{
        ...
        key = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(key);
    ...
    const runBatch = (items, commonOptions, cb)=>{
        ...
        for (const item of items){
            ...
            const key = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(isStringItem ? item : item.key);
    ...
    const storage = {
        ...
        hasItem (key, opts = {}) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(driver.hasItem, relativeKey, opts);
        },
        getItem (key, opts = {}) {
            key = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(key);
            const { relativeKey, driver } = getMount(key);
        ...
        getItems (items, commonOptions = {}) {
            return runBatch(items, commonOptions, (batch)=>{
                if (batch.driver.getItems) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(batch.driver.getItems, batch.items.map((item)=>({
                            key: item.relativeKey,
                            options: item.options
                        })), commonOptions).then((r)=>r.map((item)=>({
                                key: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["j"])(batch.base, item.key),
                ...
                return Promise.all(batch.items.map((item)=>{
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(batch.driver.getItem, item.relativeKey, item.options).then((value)=>({
                            key: item.key,
        ...
        getItemRaw (key, opts = {}) {
            ...
            if (driver.getItemRaw) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(driver.getItemRaw, relativeKey, opts);
            }
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(driver.getItem, relativeKey, opts).then((value)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(value));
        },
        async setItem (key, value, opts = {}) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(driver.setItem, relativeKey, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["d"])(value), opts);
            if (!driver.watch) {
                onChange("update", key);
            }
        },
        async setItems (items, commonOptions) {
            await runBatch(items, commonOptions, async (batch)=>{
                if (batch.driver.setItems) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(batch.driver.setItems, batch.items.map((item)=>({
                            key: item.relativeKey,
                            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["d"])(item.value),
                            options: item.options
                        })), commonOptions);
                }
                ...
                await Promise.all(batch.items.map((item)=>{
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(batch.driver.setItem, item.relativeKey, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["d"])(item.value), item.options);
                }));
            });
        },
        async setItemRaw (key, value, opts = {}) {
            ...
            if (driver.setItemRaw) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(driver.setItemRaw, relativeKey, value, opts);
        ...
        async removeItem (key, opts = {}) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(driver.removeItem, relativeKey, opts);
        ...
        async getMeta (key, opts = {}) {
            ...
            if (driver.getMeta) {
                Object.assign(meta, await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(driver.getMeta, relativeKey, opts));
            }
            if (!opts.nativeOnly) {
        ...
        async getKeys (base, opts = {}) {
            base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])(base);
            ...
            for (const mount of mounts){
                ...
                const rawKeys = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(mount.driver.getKeys, mount.relativeBase, opts);
                for (const key of rawKeys){
                    const fullKey = mount.mountpoint + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(key);
        ...
        async clear (base, opts = {}) {
            ...
            await Promise.all(getMounts(base, false).map(async (m)=>{
                if (m.driver.clear) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(m.driver.clear, m.relativeBase, opts);
                }
        ...
        getMounts (base = "", opts = {}) {
            base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(base);
...
async function dispose(driver) {
    if (typeof driver.dispose === "function") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$core$2f$node_modules$2f$unstorage$2f$dist$2f$shared$2f$unstorage$2e$CoCt7NXC$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(driver.dispose);
    }
}
...
//# sourceMappingURL=node_modules_5baa9d4b._.js.map